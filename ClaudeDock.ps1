...
$Host.UI.RawUI.WindowTitle = "ClaudeDock v4"
...
if (Test-Path $icoPath) {
    ...
    $bgBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(204, 120, 50))
...
if (-not $script:iconBitmap) {
    ...
    $fbBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(204, 120, 50))
...
function Update-TrayTooltip {
    try {
        ...
        if (-not $script:config.PSObject.Properties['notifications']) {
            $script:notifyIcon.Text = "ClaudeDock"
            return
        }
        $usCfg = $script:config.notifications.usage_stats
        ...
        $tip = "ClaudeDock | Today: $($tokLabel) tok, $msgs msgs"
...
function Show-LaunchToast($projectName, $action) {
    try {
        ...
        $script:activeToast.BackColor = [System.Drawing.Color]::FromArgb(18, 18, 18)
        ...
        $script:activeToast.Add_Paint({
            ...
            try {
                ...
                $amberBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(204, 120, 50))
...
function Initialize-LauncherForm {
    ...
    $form.Add_Paint({
        ...
        try {
            ...
            # Colors
            # Terminal / command prompt color palette
            ...
            $amberColor = [System.Drawing.Color]::FromArgb(204, 120, 50)
            $whiteColor = [System.Drawing.Color]::FromArgb(204, 204, 204)
            $greenColor = [System.Drawing.Color]::FromArgb(22, 198, 12)
            $yellowColor = [System.Drawing.Color]::FromArgb(249, 241, 165)
            $blueColor = [System.Drawing.Color]::FromArgb(59, 120, 255)
            ...
            # Monospace fonts
            $headerFont = New-Object System.Drawing.Font("Consolas", 10, [System.Drawing.FontStyle]::Italic)
            $itemFont = New-Object System.Drawing.Font("Consolas", 10)
            $accelFont = New-Object System.Drawing.Font("Consolas", 10, [System.Drawing.FontStyle]::Bold)
            $statusFont = New-Object System.Drawing.Font("Consolas", 8)
            $footerFont = New-Object System.Drawing.Font("Consolas", 8)
            $filterFont = New-Object System.Drawing.Font("Consolas", 9)
            $previewFont = New-Object System.Drawing.Font("Consolas", 8, [System.Drawing.FontStyle]::Italic)
            $labelFont = New-Object System.Drawing.Font("Consolas", 7.5)
            ...
            if ($script:currentPhase -eq 1) {
                $g.DrawString("ClaudeDock", $headerFont, $dimBrush, $headerTextX, $y + 3)
            } elseif ($script:currentPhase -eq 2) {
    ...
    $form.Add_MouseDown({
        ...
        try {
            ...
            if ($proj.isPinned) {
                ...
                $unpinItem.ForeColor = [System.Drawing.Color]::FromArgb(204, 120, 50)
                $unpinItem.Add_Click({
...
function Build-Menu() {
    try {
        ...
        $contextMenu.BackColor = [System.Drawing.Color]::FromArgb(12, 12, 12)
        ...
        $header.ForeColor = [System.Drawing.Color]::FromArgb(150, 150, 150)
        ...
        foreach ($proj in $script:allProjects) {
            ...
            $projItem.BackColor = [System.Drawing.Color]::FromArgb(12, 12, 12)
        ...
        $testNotif.BackColor = [System.Drawing.Color]::FromArgb(12, 12, 12)
        $testNotif.Add_Click({
            $ErrorActionPreference = "Continue"
            try {
        ...
        $quit.BackColor = [System.Drawing.Color]::FromArgb(12, 12, 12)
        $quit.Add_Click({
            $ErrorActionPreference = "Continue"
            try {
                # Timers
        ...
        foreach ($item in $contextMenu.Items) {
            if ($item -is [System.Windows.Forms.ToolStripSeparator]) {
                $item.BackColor = [System.Drawing.Color]::FromArgb(12, 12, 12)
...
if (-not $script:claudeAvailable) {
    $script:notifyIcon.ShowBalloonTip(10000, "Claude Code not found",
        "ClaudeDock requires Claude Code CLI. Install from https://claude.ai/download",
...
if (-not $registered) {
    ...
    [System.Windows.Forms.MessageBox]::Show(
        ...
        "ClaudeDock", "OK", "Warning") | Out-Null
